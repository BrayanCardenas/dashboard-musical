		...
		<div className="bg-neon min-h-screen flex items-center justify-center p-4">
			<div className="bg-white flex flex-col gap-4 p-6 rounded-xl w-[450px]">
				...
				<form action="" className="flex flex-col gap-4">
					...
					<input type="email" name="email" id="email" className="border rounded-xl p-2 border-gray-300" />
					<label htmlFor="password" className="font-bold">Password</label>
					<input type="password" name="password" id="password" className="border rounded-xl p-2 border-gray-300" />
					<button type="submit" className="bg-neon rounded-xl font-bold p-2">Iniciar Sesión</button>
				</form>
			</div>
		</div>
	)
